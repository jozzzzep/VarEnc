...
namespace Benchmark.OldTypes
{
    public class EncString_0_9_0
    {
        ...
        public bool IsEqual(EncString_0_9_0 encString) => encString.Value == this.Value;
        ...
        public EncString_0_9_0(string value)
        {
            _encryptionKey = RandomString();
            _encryptedValue = EncryptorDecryptor(value, _encryptionKey);
        }

        public EncString_0_9_0(char[] value)
            : this(new string(value)) { }

        public EncString_0_9_0(char c, int count)
            : this(new string(c, count)) { }

        public EncString_0_9_0(char[] value, int startIndex, int length)
        ...
        /// + 
        public static EncString_0_9_0 operator +(EncString_0_9_0 enc, string n) => new EncString_0_9_0(enc.Value + n);
        public static string operator +(string n, EncString_0_9_0 enc) => enc.Value + n;

        /// == != < >
        public static bool operator ==(EncString_0_9_0 es1, string es2) => es1.Value == es2;
        public static bool operator !=(EncString_0_9_0 es1, string es2) => es1.Value != es2;

        /// assign
        public static implicit operator EncString_0_9_0(string value) => new EncString_0_9_0(value);
        public static implicit operator string(EncString_0_9_0 encString) => encString.Value;
