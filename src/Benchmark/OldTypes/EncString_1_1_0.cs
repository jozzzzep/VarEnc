...
namespace Benchmark.OldTypes
{
    public class EncString_1_1_0
    {
        ...
        #region Methods
        public bool IsObjectEqual(EncString_1_1_0 encString) => encString == this;
        ...
        public EncString_1_1_0(string value)
        {
            _encryptionKeys = EncKeys();
            _encryptedValue = Encrypt(value, _encryptionKeys);
        }

        public EncString_1_1_0(char[] value)
            : this(new string(value)) { }

        public EncString_1_1_0(char c, int count)
            : this(new string(c, count)) { }

        public EncString_1_1_0(char[] value, int startIndex, int length)
        ...
        /// + 
        public static EncString_1_1_0 operator +(EncString_1_1_0 enc, string n) => new EncString_1_1_0(enc.Value + n);
        public static string operator +(string n, EncString_1_1_0 enc) => enc.Value + n;

        /// == != < >
        public static bool operator ==(EncString_1_1_0 es1, string es2) => es1.Value == es2;
        public static bool operator !=(EncString_1_1_0 es1, string es2) => es1.Value != es2;
        public static bool operator ==(EncString_1_1_0 es1, EncString_1_1_0 es2) => es1.Value == es2.Value;
        public static bool operator !=(EncString_1_1_0 es1, EncString_1_1_0 es2) => es1.Value != es2.Value;

        /// assign
        public static implicit operator EncString_1_1_0(string value) => new EncString_1_1_0(value);
        public static explicit operator EncString_1_1_0(char[] value) => new EncString_1_1_0(value);
        public static implicit operator string(EncString_1_1_0 encString) => encString.Value;
